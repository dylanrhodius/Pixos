const CARD_DATA_OBJECT =
  {
    deckLimit: 25,
    cards: [
      { _id: 1, name: 'alvarezsaurus', imgUrl: '/img/alvarezsaurus.svg', type: 'land', power: 3, cost: 6, special: 'resurrector', doubled: 'false'  },
      ...
      { _id: 7, name: 'bactrosaurus', imgUrl: '/img/bactrosaurus.svg', type: 'land', power: 4, cost: 7, special: 'resurrector', doubled: 'false'  },
      ...
      { _id: 15, name: 'clam', imgUrl: '/img/clam.svg', type: 'water', power: 1, cost: 3, special: 'resurrector', doubled: 'false'  },
      ...
      { _id: 24, name: 'hummingbird', imgUrl: '/img/hummingbird.svg', type: 'air', power: 1, cost: 6, special: 'meteor', doubled: 'false'  },
      ...
      { _id: 27, name: 'jellyfish', imgUrl: '/img/jellyfish.svg', type: 'water', power: 8, cost: 15, special: 'resurrector', doubled: 'false'  },
      ...
      { _id: 32, name: 'pelicanimimus', imgUrl: '/img/pelicanimimus.svg', type: 'land', power: 1, cost: 3, special: 'resurrector', doubled: 'false'  },
      ...
      { _id: 37, name: 'sauropelta', imgUrl: '/img/sauropelta.svg', type: 'land', power: 3, cost: 5, special: '', doubled: 'false'  },
